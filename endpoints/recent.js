      ...
      .then(() => {
        ...
        sync_promise.then(() => {
          ...
          for (const match of synced_matches) {
            ...
            const teamScore = match.info.teams[allyIndex].objectives.champion.kills;
            const enemyScore = match.info.teams[enemyIndex].objectives.champion.kills;
            var gameType;
            ...
            const temp_match = new Match(won, wasDraw, playerCount, teamScore, enemyScore, gameType, timestamp);
